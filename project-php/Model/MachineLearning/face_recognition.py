...
# read the image
img = cv2.imread("Model/MachineLearning/upload/test.png")
...
# load the predictor:
predictor = dlib.shape_predictor("Model/MachineLearning/shape_predictor_68_face_landmarks.dat")
...
cv2.imwrite("Model/MachineLearning/end/test.png",img)
